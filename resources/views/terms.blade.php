...
<div class="mx-12 mt-8 ontainer">
    ...
    <p>These terms and conditions outline the rules and regulations for the use of <span
            class="highlight preview_company_name">Company Name</span>'s Website, located at <span
    ...
    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use <span
            class="highlight preview_website_name">Website Name</span> if you do not agree to take all of the terms and
    ...
    <p>We employ the use of cookies. By accessing <span class="highlight preview_website_name">Website Name</span>, you
        agreed to use cookies in agreement with the <span class="highlight preview_company_name">Company Name</span>'s
        Privacy Policy.</p>
    ...
    <p>Unless otherwise stated, <span class="highlight preview_company_name">Company Name</span> and/or its licensors
        own the intellectual property rights for all material on <span class="highlight preview_website_name">Website
            Name</span>. All intellectual property rights are reserved. You may access this from <span
            class="highlight preview_website_name">Website Name</span> for your own personal use subjected to
    ...
    <ul class="pl-8 list-disc list-inside">
        ...
        <li>Sell, rent or sub-license material from <span class="highlight preview_website_name">Website Name</span>
        </li>
        <li>Reproduce, duplicate or copy material from <span class="highlight preview_website_name">Website Name</span>
        </li>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. <span class="highlight preview_company_name">Company Name</span> does not filter, edit,
        publish or review Comments prior to their presence on the website. Comments do not reflect the views and
        opinions of <span class="highlight preview_company_name">Company Name</span>,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, <span class="highlight preview_company_name">Company Name</span> shall not be liable for the
    ...
    <p><span class="highlight preview_company_name">Company Name</span> reserves the right to monitor all Comments and
        to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and
        Conditions.</p>
    ...
    <p>You hereby grant <span class="highlight preview_company_name">Company Name</span> a non-exclusive license to use,
        reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms,
        formats or media.</p>
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of <span
            class="highlight preview_company_name">Company Name</span>; and (d) the link is in the context of general
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to <span class="highlight preview_company_name">Company Name</span>. Please
        include your name, your organization name, contact information as well as the URL of your site, a list of any
        URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to
    ...
    <p>No use of <span class="highlight preview_company_name">Company Name</span>'s logo or other artwork will be
