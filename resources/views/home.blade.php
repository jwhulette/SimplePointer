...
@section('content')
    ...
    <div class="flex flex-col mx-auto xl:mt-8 md:mt-4">
        ...
        <div class="grid gap-2">
            ...
            <div class="p-6 border-2 border-green-300 rounded-md md:max-w-sm md:mx-auto">
                <form action="{{ route('rooms_index') }}" method="post">
                    ...
                    <div class="my-6">
                        ...
                        <input name="name"
                               class="block w-full px-4 py-2 leading-normal bg-white border border-gray-300 rounded-lg appearance-none focus:outline-hidden focus:shadow-outline"
                               autocomplete="off"
                               data-1p-ignore
                               data-bwignore
                               data-lpignore="true"
                    ...
                    <div class="my-6">
                        ...
                        <div class="relative inline-block">
                            <select
                                class="block w-full px-4 py-2 pr-8 leading-tight bg-white border border-gray-400 rounded-lg shadow-sm appearance-none hover:border-gray-500 focus:outline-hidden focus:shadow-outline"
                                name="card_set">
                    ...
                    <div class="my-6 text-center">
                        <button class="px-4 py-2 font-bold text-white bg-green-600 rounded-sm hover:bg-green-400"
            ...
            {{-- <div class="px-4 py-2 mt-4 mb-4 text-white bg-green-500 border-0 rounded-sm md:max-w-md md:mx-auto">
