<template>
    <div>
        <div class="grid grid-cols-2 gap-2">
            <div class="py-2 pr-3">
                <button
                    class="float-right px-1 py-1 font-semibold text-green-700 bg-transparent border border-green-500 rounded-sm hover:bg-green-500 hover:text-white hover:border-transparent"
                    type="button"
                    @click="clearVotes"
                >Clear Votes
                </button>
            ...
            <div class="py-2 pl-3">
                <button
                    class="px-1 py-1 font-semibold text-green-700 bg-transparent border border-green-500 rounded-sm hover:bg-green-500 hover:text-white hover:border-transparent"
                    type="button"
                    @click="showVotes"
                >Show Votes
                </button>
        ...
        <div class="grid grid-cols-1 mx-auto md:w-3/4 lg:w-1/4">
