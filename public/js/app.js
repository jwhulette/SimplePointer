...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    ...
    vote: function vote(data) {
      ...
      var allUsersVoted = voters.filter(function (player) {
  ...
  mounted: function mounted() {
    ...
    this.channel.listen("UserVoted", function (e) {
      _this.vote = e.vote;
  ...
  computed: {
    averageVotes: function averageVotes() {
      ...
      var votetotal = this.players.map(function (player) {
        var vote = player.vote; // Check to see if vote is question mark
        ...
        return vote.toLocaleString(undefined, // leave undefined to use the browser's locale,
      ...
      var total = votetotal.reduce(function (total, vote) {
  ...
  methods: {
    ...
    resetBoard: function resetBoard(voters) {
      this.players = voters;
      this.showVote = false;
    }
  }
...
var render = function() {
  ...
  return this.observers.length > 0
    ? _c("div", [
        _c("div", { staticClass: "mt-6 overflow-hidden rounded rounded-lg" }, [
          _vm._m(0),
          _vm._v(" "),
          _c(
            "div",
        ...
        [
          ...
          _c("tfoot", [
            _c("tr", { staticClass: "text-right" }, [
              _c("td", { staticClass: "py-2 pr-12", attrs: { colspan: "2" } }, [
                _c("b", [_vm._v("Vote Average:")]),
                _vm._v(" "),
                _vm.showVote
                  ? _c("span", [_vm._v(_vm._s(_vm.averageVotes))])
                  : _c("span", [_vm._v("-----")])
              ])
            ])
          ])
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "flex flex-col mx-auto" }, [
      ...
      _c("div", { staticClass: "grid grid-cols-3 gap-2" }, [
        _c("div", { staticClass: "m-auto w-300 h-250" }, [_vm._v(" ")]),
        _vm._v(" "),
        _vm.hasJoined
          ? _c(
              "div",
...
__webpack_require__(/*! /Users/wes/Documents/Projects/SimplePointer/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/wes/Documents/Projects/SimplePointer/resources/sass/app.scss */"./resources/sass/app.scss");
